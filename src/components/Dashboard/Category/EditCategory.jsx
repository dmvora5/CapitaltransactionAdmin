...
const EditCategory = () => {
	...
	const [submit, updateCategoryOption] = useUpdateCategoryMutation();
	...
	useEffect(() => {
		...
		form.setValue("value", data.data.value);
	}, [isSuccess, data]);
	...
	return (
		<>
			{(isLoading || updateCategoryOption.isLoading) && <Loader />}
